...
export const getPaciente = async () => {
    const dataList = await fetch(`https://med-consult-app.onrender.com/api/consultaSecretario/${window.location.pathname.split('/')[2]}`, {
        method: 'GET',
        headers: {
...
export const updatePaciente = async (pacienteId, pacienteData) => {
    ...
    const sendData = await fetch(`https://med-consult-app.onrender.com/api/consultaSecretario/${pacienteId}`, {
        method: 'PATCH',
        headers: {
